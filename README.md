...
6. **Kelimeleri telefona aktar:** her cihazın kelimeleri ayrı saklanır. Bilgisayardaki uygulamada **⚙️ Ayarlar → Kelimelerimi telefona gönder**'e bas; telefondaki uygulamada **⚙️ Ayarlar → Kelimeleri bilgisayardan al**'a bas. Aynı kelime iki kez eklenmez; "bildim" işaretleri ve listeler de gelir. Aktarma kutusunun süre sınırı yoktur ve okununca silinmez (birkaç cihaz alabilir); yeniden "gönder" eskisinin üzerine yazar. İnternetteki sürüme aktarmak için telefonda `…:8765/__yedek` adresinden yedeği dosya olarak indirip o sürümde **Yedeği yükle** kullan. Telefonda eklediklerini bilgisayara taşımak için **Yedeği indir / Yedeği yükle** kullanılır.
